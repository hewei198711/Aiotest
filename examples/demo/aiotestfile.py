...
class TestLoadShape(LoadUserShape):
    ...
    stages = [
        {"duration": 300, "user_count": 300, "rate": 30},    # 0-300秒：300个用户，每秒启动300个
        {"duration": 2400, "user_count": 3000, "rate": 150},    # 300-2400秒：3000个用户，每秒启动150个
        {"duration": 3000, "user_count": 1500, "rate": 50},    # 2400-3000秒：1500个用户，每秒启动50个
        {"duration": 3300, "user_count": 300, "rate": 30},    # 3000-3300秒：300个用户，每秒启动30个
    ]

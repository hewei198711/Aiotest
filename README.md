...
![数据表概览](%E6%95%B0%E6%8D%AE%E8%A1%A8.jpg)

#### 控制中心界面

![控制中心](%E6%8E%A7%E5%88%B6%E4%B8%AD%E5%BF%83.jpg)
...
1. **系统资源面板**：监控 CPU、内存、网络等系统资源使用情况
1. **用户行为面板**：展示用户数量、并发数、请求分布等信息
1. **分布式节点面板**：监控各个 Worker 节点的运行状态
...
- [demo/](examples/demo/) - 完整的负载测试项目示例，包含 Docker 部署和 Prometheus 监控配置，详见 [TEST_DEMO.md](examples/demo/TEST_DEMO.md)
...
1. 查看 [示例代码](examples/)
1. 提交 [Issue](https://github.com/hewei198711/Aiotest/issues)
